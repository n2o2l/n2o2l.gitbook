...
WST的ART18CX:admin:conexant/user:assword  
...
TANDBERG        TANDBERG        8000        Multi        (none)        TANDBERG        Admin        http://www.tandberg.net/collater ... RG_8000_UserMan.pdf  
...
X-Micro        WLAN 11b Access Point        01/02/2002        Multi        super        super        Admin        http://secunia.com/advisories/11342/  
...
Netgear        WGT624                Serial console        Gearguy        Geardog        Admin        see http://wiki.openwrt.org/OpenWrtDocs/Hardware/Netgear/WGT624  
...
Westell        Ultraline Series3 A90-9100EM15-10        1.02.00.04                admin        password1        Admin        Verizon cable router (Model 9100EM on front)  
CNet        CWR- 500 Wireless-B Router                        Admin        admin        Admin          
ZyXel Based (Generic)        Broadband SOHO Router        925ahcd on circuit board print                admin        0        Admin        Password is 4 zeros. Gray router with pink bezel.  
...
T-Com        Speedport        any                n/a        0        admin        192.168.2.1 | http://Speedport.ip |  
...
Bosch        NWC-0455 Dinion IP Cameras                        service        service        admin        may work in other bosch ip cameras  
...
Symmetricom        NTS-200        All                operator        mercury        Admin        Symmetricom NTP Network Appliance  
Symmetricom        NTS-200        All                guest        truetime        guest        Symmetricom NTP Network Appliance  
Sharp        AR-M237                        admin        Sharp        Admin        pass case-sensitive  
Netgear        WGR614        9                admin        password        Admin        192.168.1.1 OR www.routerlogin.net  
...
顺网无线.连我168WiFi后台的初始密码 lianwo168  
...
重庆普天CPADSL03http://192.168.1.1username:rootpassword:root   
台湾突破EA110RS232:38400http://192.168.7.1username:SLpsw:SL   
etek-td的ADSL_T07L006.0[url]http://192.168.1.1UserName:supervisor   
Password:12345   
...
绿盟扫描器 虚拟机帐号密码  conadmin/conadmin   web帐号密码 admin/nsfocus1  
...
<DM name="Pass" val="telecomadmin50761836"/>  
  
Runckus Wireless Admin的  
super/sp-admin  
  
天融信的默认账号应该是superman 密码talent 吗  
  
cisco cisco root cisco  
